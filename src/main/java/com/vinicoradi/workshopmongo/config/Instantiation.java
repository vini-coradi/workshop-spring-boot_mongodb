package com.vinicoradi.workshopmongo.config;
...
import com.vinicoradi.workshopmongo.dto.AuthorDTO;
import com.vinicoradi.workshopmongo.dto.CommentDTO;
import com.vinicoradi.workshopmongo.repository.PostRepository;
import com.vinicoradi.workshopmongo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Muita alegria, que Deus te ilumine", new AuthorDTO(maria));
